---
title: NanoBot-Learning
date: 2026-08-23
tags: [AI, Agent, NanoBot, Python, Learning]
aliases: [NanoBot 学习]
---

# NanoBot 源码学习

NanoBot 的长期学习计划、章节、实验和复习记录已经迁移到独立公开仓库。大知识库只保留
这个入口，避免长期课程的提交历史和普通知识笔记混在一起。

## 入口

- [GitHub 仓库](https://github.com/comet-7x/nanobot-learning)
- [学习导读](https://github.com/comet-7x/nanobot-learning/blob/main/quickstart.md)
