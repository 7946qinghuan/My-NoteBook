...
>
>[如何在 WSL2 上安装 Hailo 数据流编译器（DFC）](https://community.hailo.ai/t/how-to-install-the-hailo-dataflow-compiler-dfc-on-wsl2/2890)
>
...
>
>[数据流编译器安装](https://hailo.ai/developer-zone/documentation/dataflow-compiler-v3-31-0/?sp_referrer=install/install.html)
>
>[Hailo 命令行界面 | Hailo --- Hailo Command Line Interface | Hailo](https://hailo.ai/zh-hans/developer-zone/training-and-support/command-line-interface-tutorial/)
>
>[【树莓派 5+AI_KIT】基于 hailo 模块转换重新训练的 YOLO 模型_hailo8 yolo-CSDN 博客](https://blog.csdn.net/2301_76725922/article/details/143829506)
