...
> 文档用途：供虚拟谈判模块配置及向苏老师、李老师确认时使用。  
> 核验口径：优先采用 WTO、IOTC 官方法律文本、议事规则、会议报告和会议文件。  
...
3. **IOTC 不能把全部议题压成同一条八步流程。**建议产品采用“共同骨架 + 流程变体”：科学咨询、配额分配、履约审查、财政行政、管理程序、委员会决议六类流程共享开幕、议程、讨论、报告等基础节点，但输入材料、决策主体、通过方式和会后效力不同。
